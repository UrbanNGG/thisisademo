	...
	<div class="app">
		<header class="header header-fixed navbar">
			...
			<ul class="nav navbar-nav">
				...
				<?PHP
				if($server->get("permissions")->permissionCheck('C_ALL') || $server->get("permissions")->permissionCheck('cp_admin'))
				{
				?>
				<li class="header-search">
					<a class="toggle-search" href="javascript:;"><i class="ti-search"></i></a>
					<div class="search-container">
						<form role="search" method='POST' action='./admin.php?p=records'>
							<input class="form-control search" name='field' id='cunt' placeholder="search for an account (John_Doe)">
							<input type="hidden" name='v' value="<?php echo $_SESSION['session_id']; ?>">
						</form>
					</div>
				</li>
			<?php } ?>
			...
			<section class="main-content">
				<?php
					...
					else
					{
						...
						$p_url = "./pages/main/".$default_template."/".$default_template.".php";
						//echo $p_url;
						include($p_url);
					}
